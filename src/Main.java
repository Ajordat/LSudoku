...
public class Main {
	...
	public static void main(String[] args) throws IOException {		
		...
		try{
			...
			br.close();
			System.out.println("Hi ha "+numPlenes+" caselles plenes.");
			...
			System.out.println("Sembla que el fitxer que has escollit no és del tot correcte.");
		}
		catch(Exception e){
			System.out.println("No s'ha pogut obrir el fitxer escollit.");
		}
	}
